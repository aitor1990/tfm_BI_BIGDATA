...
# etl tasks
country_etl_task = throw_task(dag, join, COUNTRY_DIMENSION_ETL_PATH, 'country_dimension')
throw_task(dag, country_etl_task, TOURISM_FACT_ETL_PATH, 'tourism_facts')
throw_task(dag, country_etl_task, LABOUR_FACT_ETL_PATH, 'labour_facts')
